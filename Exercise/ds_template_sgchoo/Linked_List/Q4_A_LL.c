...
void moveEvenItemsToBack(LinkedList *ll)
{
	...
	{
		ListNode *evenNode = ll->head;

		while(evenNode->item % 2 != 0 && evenNode->next != NULL)
		{
			preNode = evenNode;
			evenNode = evenNode->next;
		}

		if(evenNode->item % 2 != 0 && evenNode->next != NULL)
		{
			evenNode = evenNode->next;
			continue;
		}
